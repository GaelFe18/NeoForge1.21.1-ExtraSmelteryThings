...
public class BasicAlloyerBlockRecipeCategory implements IRecipeCategory<BasicAlloyerBlockRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(ExtraSmelteryThings.MOD_ID, "basic_alloyer_block");
    ...
    public static final RecipeType<BasicAlloyerBlockRecipe> BASIC_ALLOYER_BLOCK_RECIPE_RECIPE_TYPE =
            new RecipeType<>(UID, BasicAlloyerBlockRecipe.class);

    private final IDrawable background;
    private final IDrawable icon;

    public BasicAlloyerBlockRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 138, 56);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.BASIC_ALLOYER_BLOCK));
    }

    @Override
    public RecipeType<BasicAlloyerBlockRecipe> getRecipeType() {
        return BASIC_ALLOYER_BLOCK_RECIPE_RECIPE_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BasicAlloyerBlockRecipe recipe, IFocusGroup iFocusGroup) {
